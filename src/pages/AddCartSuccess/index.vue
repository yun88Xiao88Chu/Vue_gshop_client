  ...
  <div class="cart-complete-wrap">
    <div class="cart-complete">
      ...
      <div class="goods">
        ...
        <div class="right-gocart">    <!-- 属性名和路由里面skuId一致,属性值是Detail组件跳转时指定的属性名 -->
          <router-link class="sui-btn btn-xlarge"
          :to="`/detail/${$route.query.skuId}`">查看商品详情</router-link>
          <router-link :to="{path:'/shopcart'}">去购物车结算 > </router-link>
        </div>                                
      </div>
    </div>
  </div>
